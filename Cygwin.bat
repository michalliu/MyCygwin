...
SET BASHPROFILE_SRC=%WORKING_DIR%.bashrc
SET BASHPROFILE_NEW=%WORKING_DIR%home\michalliu\.bash_profile
...
IF EXIST %BASHPROFILE_NEW% (
	REM DO NOTHING
) ELSE (
	COPY %BASHPROFILE_SRC% %BASHPROFILE_NEW% > nul
)
